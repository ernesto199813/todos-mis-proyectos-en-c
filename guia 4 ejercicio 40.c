...
empleados a los que se le calculo el salario*/
...
int salario_semanal,tarifa_horaria,NDHT,nombre,n,contador=0,salir;
...
printf("Nombre de la persona: %s",nombre);

printf("\nLa tarifa horaria es de: %i",tarifa_horaria);

printf("\nNumero de horas trabajadas: %i",NDHT);

printf("\nEl salario semanal es: %i ",salario_semanal);

printf("\nCantidad de empleados a los que se le calculo el salario: %i",contador);
