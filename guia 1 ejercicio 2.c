...
/* opc=opciones , clv=clave que sera la predeterminada que es (1234) , saldo=la cantidad de saldo que disponemos en la cuenta que es 520 , 
n1=primera variable para validar su ingreso de clave n2=segunda variable para validar con respecto a el menu de opciones   */	
int opc, clv,saldo=520,n1,n2,salir ;

/* caracter de numero y clave para validar  */	
...
printf("Ingrese su clave(la clave predeterminada es 1234): ");	

scanf("%s",& clave);


n1=validar_numeros(clave);
...
if(depositar>=1 && depositar<=1000000){

b=depositar<1;}else{ printf("Ingrese una cantidad de deposito valida");
