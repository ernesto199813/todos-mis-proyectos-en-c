...
empleados a los que se le calculo el salario,el empleado con el mejor salario y el empleado con el peor salario*/
...
int salario_semanal[1000],tarifa_horaria,NDHT,n,salir,mayor_salario=0,menor_salario=0,aux=0,aux2=0,empleados,i;
...
printf("Nombre de la persona: %s",Nombre[i]);

printf("\nLa tarifa horaria es de: %i",tarifa_horaria);

printf("\nNumero de horas trabajadas: %i",NDHT);

printf("\nEl salario semanal es: %i ",salario_semanal[i]);

printf("\nCantidad de empleados a los que se le calculo el salario: %i",i);

printf("\nEl empleado con el mayor salario es %s con %i",Nombre[aux],mayor_salario);

printf("\nEl empleado con el menor salario es %s con %i",Nombre[aux2],menor_salario);}
